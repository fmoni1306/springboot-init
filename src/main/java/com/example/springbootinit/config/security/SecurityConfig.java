...
import com.example.springbootinit.jwt.*;
...
public class SecurityConfig {
    ...
    public WebSecurityCustomizer ignoringCustomizer() {
        ...
        return (web) -> web.ignoring().requestMatchers(WHITELIST).requestMatchers(PathRequest.toStaticResources().atCommonLocations());
    }
    /**
    ...
    public SecurityFilterChain config(HttpSecurity http) throws Exception {
        ...
        // cors 설정 disabled -> 추가 설정이 필요할 수 있음
//        http.cors().disable();
